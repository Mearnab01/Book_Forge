...
import { Library, Mail, Lock, Eye, EyeOff, BookOpen, Users, Clock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex bg-linear-to-r from-gray-900 via-purple-950 to-gray-900">
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mt-10 rounded-xl bg-gray-800/30 backdrop-blur-sm border border-gray-700 p-6">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-gray-400"><span className="text-blue-400 font-medium">Admin:</span> admin@library.com / admin123</p>
              <p className="text-gray-400"><span className="text-purple-400 font-medium">Librarian:</span> librarian@library.com / lib123</p>
              <p className="text-gray-400"><span className="text-emerald-400 font-medium">Member:</span> member@library.com / member123</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:flex lg:flex-1 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-500/20 rounded-full mix-blend-screen filter blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
          <div className="max-w-lg text-center">
            ...
            <p className="text-lg text-gray-300 mb-10 leading-relaxed">
              ...
              Track books, manage members, and handle transactions effortlessly.
            </p>
